      ...
      child: Padding(
        ...
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              RichText(text: TextSpan(text: title, style: const TextStyle(fontWeight: FontWeight.bold)),),
              const Divider(),
              Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  SizedBox(width: 175, child: Text(text, style: const TextStyle(color: Colors.black))), 
                  const Spacer(), 
                  Column(
